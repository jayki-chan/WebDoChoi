                                        ...
                                        <div class="flex-grow min-w-0">
                                            ...
                                            <div class="flex items-center justify-between text-xs mb-1">
                                                <div class="flex items-center space-x-1">
                                                    <button type="button" 
                                                            onclick="updateCartQuantity(<%# Eval("Id") %>, <%# Convert.ToInt32(Eval("Quantity")) - 1 %>)"
                                                    ...
                                                    <input type="number" 
                                                           value="<%# Eval("Quantity") %>" 
                                                           min="1" 
                                                           class="w-8 text-center text-xs border-0 focus:ring-0 p-0"
                                                           onchange="handleQuantityChange(this, <%# Eval("Id") %>)"
                                                           readonly />
                                                    <button type="button" 
                                                            onclick="updateCartQuantity(<%# Eval("Id") %>, <%# Convert.ToInt32(Eval("Quantity")) + 1 %>)"
                                                            class="w-5 h-5 flex items-center justify-center bg-gray-200 rounded text-xs hover:bg-gray-300">
